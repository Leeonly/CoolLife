...
-(void)creatDataArray
{
    ...
    self.array_3 = [NSArray arrayWithObjects:@"15年6月28日基准利率",@"15年5月11日基准利率",@"15年3月1日基准利率",@"14年11月22日基准利率",@"12年7月6日利率下限(7折)",@"12年7月6日利率下限(85折)",@"12年7月6日利率上限(1.1倍)",@"12年7月6日基准利率",@"12年6月8日利率上限(1.1倍)",@"12年6月8日利率下限(85折)",@"12年6月8日基准利率",@"11年7月6日利率上限(1.1倍)",@"11年7月6日利率下限(85折)",@"11年7月6日基准利率",@"11年4月5日利率上限(1.1倍)",@"11年4月5日利率下限(85折)",@"11年4月5日利率下限(7折)",@"11年4月5日基准利率",@"11年2月9日利率上限(1.1倍)",@"11年2月9日利率下限(85折)",@"11年2月9日利率下限(7折)",@"11年2月9日基准利率",@"10年12月26日利率上限(1.1倍)",@"10年12月26日利率下限(85折)",@"10年12月26日利率下限(7折)",@"10年12月26日基准利率",@"10年10月20日利率上限(1.1倍)",@"10年10月20日基准利率",@"10年10月20日利率下限(85折)",@"10年10月20日利率下限(7折)",@"08年12月23日利率上限(1.1倍)",@"08年12月23日基准利率",@"08年12月23日利率下限(85折)",@"08年12月23日利率下限(7折)", nil];
    self.array_4 = [NSArray arrayWithObjects:@"5.40%",@"5.65%",@"5.90%",@"6.15%",@"4.59%", @"5.57%", @"7.21%", @"6.55%", @"7.48%",@"5.78%", @"6.8%", @"7.75%", @"5.99%", @"7.05%", @"7.48%", @"5.78%",
                    @"4.76%", @"6.8%", @"7.26%", @"5.61%", @"4.62%", @"6.6%", @"7.04%",
                    @"5.44%", @"4.48%", @"6.4%", @"6.75%", @"6.14%", @"5.22%", @"4.3%",
                    @"6.53%", @"5.94%", @"5.05%", @"4.16%",nil];
    self.array_5 = [NSArray arrayWithObjects:@"3.50%",@"3.75%",@"4.00%",@"4.25%",@"4.5%", @"4.5%", @"4.5%", @"4.5%", @"4.7%",
