...
- (void)getPhoneData:(NSString *)phone
{
    ...
    [LeeSearchHttpTool getPhoneData:phone success:^(NSData *data) {
        ...
        if (error.integerValue == 0) {
            ...
            // 卡号类型
            [weakSelf.resultSection addItem:[WBSubtitleItem itemWithTitle:@"卡类型:" rightSubtitle:dic[@"supplier"]]];
...
- (void)dealloc
{
    LeeLog(@"PhoneSearchController dealloc");
}
